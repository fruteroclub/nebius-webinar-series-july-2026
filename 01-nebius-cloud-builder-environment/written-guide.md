...
Vercel's current docs show `pnpm i -g vercel`. For this webinar environment,
we use npm for global CLI tools and pnpm for project dependencies.
...
If npm install fails, use Vercel's documented command:
